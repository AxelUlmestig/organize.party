    ...
    case pageState.state of
        ...
        ViewEvent maybeModal event attendeeInput ->
            ...
            H.div []
                                ...
                                [ case modal of
                                    InviteGuestsInfoModal ->
                                        H.div []
                                            ...
                                            , H.div [ A.class "text-center submit-button-container" ]
                                                [ H.button [ A.class "submit-button", onClick (ViewEventMsg CloseModal), A.class "btn btn-primary" ] [ H.text "Ok" ]
                                                ]
                                            ]
                ...
                , H.div []
                    [ H.div [ A.class "edit-event-button-wrapper" ]
                        [ H.h1 [] [ H.text title ]
                        , H.a [ A.href ("/e/" ++ id ++ "/edit"), A.class "edit-event-button-href" ]
                          [ Icon.view (Icon.styled [ Icon.lg, A.style "margin" "auto" ] Icon.wrench) ]
                        ]
                    , H.div [ A.class "event-description-wrapper" ] [ H.text description ]
                    , H.div [ A.class "event-details-wrapper" ]
                        [ H.div []
                            [ H.div [ A.class "event-details-location-wrapper" ]
                                [ Icon.view (Icon.styled [ Icon.lg, A.style "margin-left" "0.5rem", A.style "margin-right" "0.5rem" ] Icon.locationDot)
                                , H.text location
                                ]
                            , H.div [ A.class "event-details-bottom-row-wrapper" ]
                ...
                , H.div []
                    ...
                    , H.div [ A.class "attendee-questionnaire-field-wrapper" ] [ H.text "Name" ]
                    , H.div []
                      [ H.input [ A.attribute "autocomplete" "name", A.class "attendee-questionnaire-field", A.value attendeeInput.name, onInput (\fn -> ViewEventMsg (UpdateAttendeeInput { attendeeInput | name = fn })), A.placeholder "Your name" ] []
                      ]
                    , H.div [ A.class "attendee-questionnaire-field-wrapper" ] [ H.text "Email" ]
                    , H.div []
                      [ H.input [ A.attribute "type" "email", A.attribute "autocomplete" "email", A.class "attendee-questionnaire-field", A.value attendeeInput.email, onInput (\e -> ViewEventMsg (UpdateAttendeeInput { attendeeInput | email = e })), A.placeholder "Your email" ] []
                      ]
                    , H.div [ A.class "attendee-questionnaire-field-wrapper" ]
                      [ H.text "plus one? "
                      , H.input [ A.type_ "checkbox", A.checked attendeeInput.plusOne, onCheck (\po -> ViewEventMsg (UpdateAttendeeInput { attendeeInput | plusOne = po })) ] []
                      ]
                    , H.div []
                    ...
                    , H.div [ A.class "text-center submit-button-container" ]
                        [ H.button [ A.class "submit-button", disableUnlessValidInput attendeeInput, onClick (ViewEventMsg (AttendMsg attendeeInput)), A.class "btn btn-primary" ] [ H.text "Submit" ]
                        ]
                    ]
                , H.br [] []
                , H.br [] []
