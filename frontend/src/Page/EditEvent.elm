    ...
    case pageState.state of
        ...
        EditEvent attendees maybeModal { picker, input } ->
            ...
            H.div []
                ...
                , H.div [] [ H.input [ A.class "input-without-icon", onInput (\t -> EditEventMsg (UpdateEditEventInput picker { input | title = t })) ] [] ]
                , H.div [] [ H.text "Description" ]
                , H.div [] [ H.textarea [ A.class "input-without-icon", borderRadius, A.value input.description, onInput (\d -> EditEventMsg (UpdateEditEventInput picker { input | description = d })) ] [] ]
                , sectionSeparator "When"
                , H.div [ A.class "date-input-flex-container d-flex flex-row justify-content-start", onClick (EditEventMsg EditEventOpenPicker) ]
                ...
                , H.div [ A.class "d-flex flex-row justify-content-start", A.style "margin-top" "1rem" ]
                    ...
                    , H.input [ A.class "input-field-with-icon", A.value input.location, onInput (\l -> EditEventMsg (UpdateEditEventInput picker { input | location = l })) ] []
                    ]
                ...
                , H.div [ A.class "input-top-margin d-flex flex-row justify-content-start" ]
                    ...
                    , H.input [ A.class "input-field-with-icon", A.value input.password, onInput (\pw -> EditEventMsg (UpdateEditEventInput picker { input | password = pw })) ] []
                    ]
                , H.div [ A.class "input-top-margin text-center" ]
                    [ H.button [ A.class "submit-button btn btn-primary", onClick (EditEventMsg SubmitEdit) ] [ H.text "Submit" ]
                    ]
                , H.br [] []
                , H.br [] []
