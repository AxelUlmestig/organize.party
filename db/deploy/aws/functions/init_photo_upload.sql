  ...
  create or replace function aws.init_photo_upload(
    ...
    $$
      ...
      begin
        ...
        if output_->>'photoId' is not null then
          return output_;
        end if;
        ...
        with
          ...
          from same_file
          returning output_ || jsonb_build_object('photoId', id, 'materializedStatus', 'upload_completed')
          into output_;
        ...
        -- the upload
        insert into aws.photo_uploads (id, file_ame, upload_url, file_base64_sha256, upload_url_expires_at)
        values (upload_id_, photo_upload_url_, base64_sha256_, now() + upload_url_lifetime_seconds_ * interval '1 second')
