-- Deploy events:statechart/aws/sns_webhook_message_flow-1.0 to pg
...
chart bigint;
begin
insert into fsm.statechart (name, version) values ('aws.sns_webhook_message_flow', 1.0::semver) returning id into chart;
