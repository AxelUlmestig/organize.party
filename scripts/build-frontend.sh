...
if [ $optimize = true ]; then
  ...
  # ------------ event-page.css ----------------------------
  EVENT_PAGE_CSS=event-page.$(sha256sum frontend/static/event-page.css | cut -d " " -f1).css
  cp frontend/static/event-page.css frontend/static/$EVENT_PAGE_CSS
else
  # ------------ Compiled JS -------------------------
  ELM_JS_FILE=elm.js
  ...
  ABOUT_CSS=about.css
  EVENT_PAGE_CSS=event-page.css
fi

cat << EOF > frontend/index.html
<!-- auto generated by scripts/build-frontend.sh, don't edit directly -->
